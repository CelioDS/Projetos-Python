...
def test_bank_operations():
    ...
    with patch("builtins.input", side_effect=["celio", "50816832812"]):
        account.create_account("celio", '50816832812')

    # Simulando o login na conta criada
    with patch("builtins.input", return_value="50816832812"):
        account.login_account('50816835203')

    assert account.user_now[1] == '508.168.328-12', "Login falhou"

    # Simulando um depósito de 1500
    with patch("builtins.input", return_value="1500"):00
1        account.deposit(deposit_value=1500)
